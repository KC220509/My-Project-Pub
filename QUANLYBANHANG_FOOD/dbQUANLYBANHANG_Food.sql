--DROP DATABASE QUANLYBANHANG_FOOD
CREATE DATABASE QUANLYBANHANG_FOOD
GO
use QUANLYBANHANG_FOOD
GO
SET DATEFORMAT DMY
...
(
    ...
    Pass VARCHAR(50) NOT NULL
		constraint CK_password CHECK(pass not in('')),
	SDT varchar(11)
)
GO
...
(
	...
	NgaySinh date
		CONSTRAINT CK_ngaysinh CHECK (DATEDIFF(YEAR, NgaySinh, GETDATE()) >= 18),
	GioiTinh char(1)
		constraint DF_GioiTinh default 'A',
		constraint CK_GioiTinh check(GioiTinh in ('A', 'U', 'L')),
	DiaChi nvarchar(100),
	SDT_KH varchar(11),
	EmailKH VARCHAR(100) 
		constraint UQ_Email_KH unique,
		constraint CK_Email_KH check(EmailKH LIKE '%_@%_._%'),
	Username varchar(50)
		constraint FK_username foreign key references ACCOUNT(Username)
			on update
				cascade
			on delete
				cascade,
...
INSERT INTO DONHANG_HOADON(MaKH, NgayTaoDH, DiaChiGiaoHang, SDTGiaoHang, NgayThanhToan, NgayGiaoHang, TrangThaiDonHang)
	VALUES	
		('05KH000004', '10/07/2022', N'56 Phạm Như Xương, Q.Liên Chiểu, TP.Đà Nẵng', '0931234327', '10/07/2022', '15/07/2022', N'Đã giao hàng'),
		('05KH000001', '12/08/2022', N'K82/87 Nguyễn Lương Bằng, Q.Liên Chiểu, TP.Đà Nẵng', '0971578235', '13/08/2022', '13/08/2022', N'Đang giao hàng'),
		('05KH000002', '25/12/2022', N'Phú Long, Kỳ Phú, Kỳ Anh, Hà Tĩnh', '0864056815', '25/12/2022', '01/01/2023', N'Đang vận chuyển'),
		('05KH000005', '03/04/2023', N'266 Nguyễn Tri Phương, TP.Đà Nẵng', '0376127631', '05/04/2023', '10/04/2023', N'Đang đóng gói'),
		('05KH000004', '05/11/2022', N'16 Trần Cao Vân, TP.Đà Nẵng', '0834381436', '06/11/2022', '11/11/2022', N'Chờ xử lý'),
		('05KH000005', '15/02/2023', N'120/2 Trưng Nữ Vương, Hải Châu, Đà Nẵng', '0854753596', '15/02/2023', '18/02/2023', N'Đã giao hàng'),
		('05KH000004', '22/03/2023', N'34 Hàng Trống, 111 Hàng Gai, Hoàn Kiếm, Hà Nội', '0834381436', '24/03/2023', '27/03/2023', N'Đang giao hàng'),
		('05KH000001', '24/04/2023', N'Số 44 ngõ 444, Đội Cấn, Ba Đình, Hà Nội', '0758378295', '25/04/2023', '30/04/2023', N'Đang giao hàng')
GO
